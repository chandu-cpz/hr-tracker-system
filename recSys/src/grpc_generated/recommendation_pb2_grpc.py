...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetJobRecommendations = channel.unary_unary(
                '/recommendation.RecommendationService/GetJobRecommendations',
...
class RecommendationServiceServicer(object):
    ...
    def GetJobRecommendations(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetJobRecommendations': grpc.unary_unary_rpc_method_handler(
                    servicer.GetJobRecommendations,
