...
export function AddJob() {
    ...
    return (
        <div className="h-screen tw-flex">
            <Sidebar />
            <div className="tw-rounded-4xl  tw-rounded-3xl tw-bg-gradient-to-b tw-from-blue-900 tw-to-blue-200 tw-p-16 tw-shadow-2xl tw-mx-auto tw-max-w-3xl tw-rounded-lg tw-p-5">
