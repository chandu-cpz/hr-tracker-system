...
export function LandingPage() {
    return (
        <div className="tw-bg-gray tw-flex tw-h-screen tw-flex-col tw-items-center tw-justify-center">
            <div>
                <h1 className="tw-m-12 tw-mt-12 tw-text-center tw-text-6xl tw-font-extrabold tw-text-black">
                    Streamline Recruiting Workflows
                </h1>
                <h1 className="tw-m-12 tw-text-center tw-text-6xl tw-font-extrabold tw-text-stone-700 tw-text-opacity-90">
                    Centralize Application Tracking{" "}
                </h1>
                <h1 className="tw-m-12 tw-text-center tw-text-6xl tw-font-extrabold tw-text-black tw-text-opacity-60">
                    {" "}
